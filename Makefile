...
deploy:
	@forge script script/DeployDynamicClockNFT.s.sol:DeployDynamicClockNFT $(NETWORK_ARGS)

mint:
	@forge script script/Interaction.s.sol:MintDynamicClockNft ${NETWORK_ARGS}
